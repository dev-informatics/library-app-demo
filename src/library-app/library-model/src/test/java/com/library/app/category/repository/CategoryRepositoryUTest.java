...
public class CategoryRepositoryUTest {
	...
	@Test
	public void addCategroyAndFindIt() throws Exception {
	...
	@Test
	public void addCategoryAndFindItByName() {
		String categoryName = null;

		try {
			em.getTransaction().begin();
			categoryName = categoryRepository.add(java()).getName();
			assertThat(categoryName, is(notNullValue()));
			em.getTransaction().commit();
			em.clear();
		} catch (final Exception e) {
			fail("this exception should have not have been thrown.");
			e.printStackTrace();
	...
	@Test
	public void alreadyExistsCategoryWithId() throws Exception {
